...
namespace SAM.Analytical.Solver.Grasshopper.Obsolete
{
    ...
    public class SnapSolver : GH_SAMComponent
    {
        ...
        protected override void SolveInstance(IGH_DataAccess DA)
        {
            ...
            Geometry.Grasshopper.Solver.Query.Snap(panelBreps, Levels, bucket, grid, gap, angle, toler, Origin, fixedlines, out OutputWalls, out OutputIds, out SlabOutlines, out Axes);
