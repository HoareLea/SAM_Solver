...
//namespace SAM.Geometry.Grasshopper.Solver.Component
//{
...
//        /// </summary>
//        public override string LatestComponentVersion => "1.5.0";
...
//        public SnapSolver()
//            : base("SnapSolver", "SnapSolver", "Snap Solver Version 1.5.0_PureSAM", "SAM", "Solver")
//        {
//        }
...
//                out List<List<List<int>>> SnappedSources,
...
//            {
//                var brepWalls = walls?.ConvertAll(f => Rhino.Convert.ToRhino_Brep(f)).ToList();
...
//            List<List<int>> SnappedSources_flatten = new List<List<int>>();
//            foreach(List<List<int>> values in SnappedSources)
//            {
//                SnappedSources_flatten.AddRange(values);
//            }

//            var snappedWallSources = ListOfListsToTree<int>(SnappedSources_flatten); 
