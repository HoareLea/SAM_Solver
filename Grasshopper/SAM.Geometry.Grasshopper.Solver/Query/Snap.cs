...
namespace SAM.Geometry.Grasshopper.Solver
{
    public static partial class Query
    {
            ...
            )
        {
            ...
            foreach (Interval level in levels)
            {
                ...
                for (int i = 0; i < wallbreps.Count; i++)
                {
                    ...
                    if (global::Rhino.Geometry.Intersect.Intersection.BrepPlane(thiswall, thiscut, tolerance, out intc, out intp))
            ...
            )
        {
            ...
            double angleSnapRad = global::Rhino.RhinoMath.ToRadians(angleSnapDeg);
