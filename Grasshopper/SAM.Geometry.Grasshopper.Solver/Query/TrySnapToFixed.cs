...
namespace SAM.Geometry.Grasshopper.Solver
{
    public static partial class Query
    {
        public static bool TrySnapToFixed(Box bucketBox, List<Line> fixedLines, out Line newAxis)
        {
            ...
            bucketBox.Inflate(global::Rhino.RhinoDoc.ActiveDoc.ModelAbsoluteTolerance, 0, 0);
            ...
            foreach (Line line in fixedLines)
            {
                ...
                bool int1 = global::Rhino.Geometry.Intersect.Intersection.LineLine(boxbottom, line, out bota, out botb);
                bool int2 = global::Rhino.Geometry.Intersect.Intersection.LineLine(boxtop, line, out topa, out topb);
